...
function attack(location,attackNum,defenseNum){
	...
	function cancelAttack(attackNum){
		...
		console.log(countyObjects[currentCounty][1]);
		countyObjects[currentCounty][1] = parseInt(countyObjects[currentCounty][1],10) + parseInt(attackNum);
		console.log(countyObjects[currentCounty][1]);
	}
